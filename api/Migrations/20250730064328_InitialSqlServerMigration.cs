        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SchoolHeadUsername = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SchoolId = table.Column<int>(type: "int", nullable: false),
                    SchoolDisplayName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    LogoImageUrl = table.Column<string>(type: "nvarchar(max)", maxLength: 500000, nullable: false),
                    NavigationType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ThemeColor = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThumbnailImageUrl = table.Column<string>(type: "nvarchar(max)", maxLength: 500000, nullable: true),
